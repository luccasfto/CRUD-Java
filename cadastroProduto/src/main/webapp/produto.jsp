				...
				<div class="form-row">
					...
					<div class="form-group col-md-4">
						...
						<input class="form-control" type="text" pattern="[0-9]+([,][0-9]{2})?" placeholder="99999,99"
							   min="0" step="any" id="preco" name="preco" value="${prod != null ? String.format('%.2f', prod.preco).replace('.',',') : ''}"/>
					</div>
					<div class="form-group col-md-4">
						<label>Data de Validade:</label>
						<input class="form-control" type="date" class="data" id="dataValidade" 
						name="dataValidade" value="${UtilsBanco.convertDateToDataBase(prod.dataValidade)}" />
					</div>
				</div>
